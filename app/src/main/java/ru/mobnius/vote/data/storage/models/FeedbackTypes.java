...
@Entity(nameInDb = "cs_feedback_types")
public class FeedbackTypes {
    ...
    @Generated(hash = 1416475024)
    public FeedbackTypes(Long id, long n_code, String c_name, String c_short_name,
