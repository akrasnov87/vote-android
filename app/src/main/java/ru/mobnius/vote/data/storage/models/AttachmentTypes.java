...
public class AttachmentTypes {
    ...
    @Generated(hash = 2130664799)
    public AttachmentTypes(Long id, long n_code, String c_name, String c_short_name,
            String c_const, boolean b_disabled, int n_order, boolean b_default) {
        this.id = id;
        this.n_code = n_code;
        this.c_name = c_name;
